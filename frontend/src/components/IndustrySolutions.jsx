      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            See how Tredy AI adapts to your specific industry, creating
            intelligent workflows that understand your business needs and
        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Experience how Tredy AI creates a complete business intelligence
              platform tailored for real estate professionals.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-purple-100 hover:shadow-xl transition-all duration-300">
            ...
            <p className="text-gray-600 mb-4">
              Lead generation, property management, client communication, and
              CRM automation specifically designed for real estate
              professionals.
            </p>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-purple-100 hover:shadow-xl transition-all duration-300">
            ...
            <p className="text-gray-600 mb-4">
              ...
              automation, and compliance workflows for healthcare providers.
            </p>
            <ul className="text-sm text-gray-500 space-y-1">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-purple-100 hover:shadow-xl transition-all duration-300">
            ...
            <p className="text-gray-600 mb-4">
              Inventory management, customer service automation, order
              processing, and marketing campaign optimization for online
              retailers.
            </p>
            <ul className="text-sm text-gray-500 space-y-1">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-purple-100 hover:shadow-xl transition-all duration-300">
            ...
            <p className="text-gray-600 mb-4">
              Financial analysis, risk assessment, compliance monitoring, and
              client portfolio management for financial institutions.
            </p>
            <ul className="text-sm text-gray-500 space-y-1">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-purple-100 hover:shadow-xl transition-all duration-300">
            ...
            <p className="text-gray-600 mb-4">
              Production planning, quality control, supply chain management, and
              equipment maintenance automation for manufacturing operations.
            </p>
            <ul className="text-sm text-gray-500 space-y-1">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-purple-100 hover:shadow-xl transition-all duration-300">
            ...
            <p className="text-gray-600 mb-4">
              Student management, course scheduling, assessment automation, and
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-purple-100 mb-6 max-w-2xl mx-auto">
              ...
              intelligent workflows that understand your business processes and
