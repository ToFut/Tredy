...
const DASHBOARD_PROMPTS = [
  {
    ...
    icon: GitBranch,
    prompt:
      "Analyze my workflow patterns and create a dashboard that mirrors my daily tasks and processes",
  ...
  },
  {
    ...
    icon: ChartLine,
    prompt:
      "Design a dashboard focused on key business insights and performance metrics",
  ...
  },
  {
    ...
    icon: Lightning,
    prompt:
      "Create a dashboard that monitors the health and status of all connected services",
  ...
  },
  {
    ...
    icon: Brain,
    prompt:
      "Design an AI-powered dashboard with smart recommendations and automated insights",
              ...
              {DASHBOARD_PROMPTS.map((prompt) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div
                      className={`p-2 bg-gradient-to-br ${prompt.color} rounded-lg`}
                    >
          ...
          <div className="p-6 border-b border-gray-200 dark:border-gray-700">
            ...
            <div className="mb-3 p-3 bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-lg border border-green-200 dark:border-green-800">
              <p className="text-sm text-green-800 dark:text-green-200 font-medium">
                🎯 Your personalized dashboard draws data from these connected
                platforms
              </p>
            ...
            <div className="grid grid-cols-3 gap-3">
              {connectors.slice(0, 6).map((connector, index) => (
                <div
                  ...
                  onClick={() =>
                    onConnectorAction && onConnectorAction(connector)
                  }
                >
                  <div className="flex items-center gap-2">
                    <div
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-700 dark:text-blue-300 mt-1">
                      Your Gmail and Calendar integration could be optimized for
                      better productivity
                    </p>
                  </div>
                </div>
              ...
              <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl border border-green-200 dark:border-green-800">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-green-700 dark:text-green-300 mt-1">
                      LinkedIn engagement is up 23% this week. Consider
