...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Tredy funciona com vários provedores de LLM. Este será o serviço que lidará com os chats.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bem-vindo ao Tredy",
      description: "Ajude-nos a melhorar o Tredy. Opcional.",
      email: "Qual seu email?",
      useCase: "Como você usará o Tredy?",
      useCaseWork: "Para trabalho",
      useCasePersonal: "Uso pessoal",
      useCaseOther: "Outro",
      comment: "Como você conheceu o Tredy?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description: "Crie seu primeiro workspace e comece a usar o Tredy.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Bem-vindo ao Tredy, uma ferramenta de IA open-source da Mintplex Labs que transforma qualquer conteúdo em um chatbot treinado. Tredy é um software BYOK (bring-your-own-keys), sem taxas ou assinaturas.",
    part2:
      "Tredy é a maneira mais fácil de integrar poderosas ferramentas de IA como OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB e outros serviços em um pacote simples.",
    part3:
      "Tredy pode rodar localmente na sua máquina com baixo consumo de recursos. Sem GPU necessária. Disponível para instalação na nuvem ou on-premises.\nO ecossistema de IA evolui rapidamente. Tredy facilita seu uso.",
  ...
  customization: {
    ...
    branding: {
      ...
      description: "Personalize sua instância do Tredy com sua marca.",
    },
    chat: {
      title: "Chat",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o Tredy.",
  ...
  privacy: {
    ...
    description:
      "Configurações de como provedores terceiros e o Tredy lidam com seus dados.",
    llm: "Seleção de LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Esses arquivos são enviados ao processador local do Tredy. Não são compartilhados com terceiros.",
    },
    pinning: {
