...
export default {
  ...
  docs: () => {
    return "https://docs.tredy.com";
  },
  chatModes: () => {
    return "https://docs.tredy.com/features/chat-modes";
  },
  mailToMintplex: () => {
    return "mailto:team@mintplexlabs.com";
  },
  hosting: () => {
    return "https://my.mintplexlabs.com/aio-checkout?product=tredy";
  },
  workspace: {
    chat: (slug, options = {}) => {
  ...
  communityHub: {
    ...
    noPrivateItems: () => {
      return "https://docs.tredy.com/community-hub/faq#no-private-items";
    },
  },

  // TODO: Migrate all docs.tredy.com links to the new docs.
  documentation: {
    mobileIntroduction: () => {
      return "https://docs.tredy.com/mobile/overview";
    },
    contextWindows: () => {
      return "https://docs.tredy.com/chatting-with-documents/introduction#you-exceed-the-context-window---what-now";
    },
  },
