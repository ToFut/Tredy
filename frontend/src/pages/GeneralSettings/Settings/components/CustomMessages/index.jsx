...
export default function CustomMessages() {
  ...
  useEffect(() => {
    async function fetchMessages() {
      ...
      setMessages(
        messages && messages.length > 0 ? messages : TREDY_DEFAULT_MESSAGES
      );
    }
    fetchMessages();
  }, []);
