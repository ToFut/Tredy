...
import { Sparkle, Plus, Robot, EnvelopeSimple, Calendar, LinkedinLogo, FileText, ChartBar, Play, FlowArrow } from "@phosphor-icons/react";
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-bold">
              Welcome to Tredy {user?.username ? `, ${user.username}` : ''}! 🚀
            </h1>
          </div>
          <div className="text-sm font-medium">
            Your AI Workflow Assistant is Ready
          </div>
        </div>
      </div>
            ...
            <div className="bg-gradient-to-b from-purple-50 to-white dark:from-gray-800 dark:to-gray-900 p-4 border-b border-gray-200 dark:border-gray-700">
              <div className="max-w-6xl mx-auto">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                  ...
                  {flows.length > 0 ? 'Your Flow Agents - Click to Run' : 'Quick Actions - Click to Start'}
                </h2>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-left flex-1 min-w-0">
                            ...
                            <p className="text-sm sm:text-xs text-gray-500 dark:text-gray-400 truncate">
                              {flow.description || `${flow.steps?.length || 0} steps`}
                            </p>
                          </div>
                        </div>
                      </button>
                    ...
                    <>
                      <button
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-left">
                            <p className="font-medium text-base sm:text-sm text-gray-900 dark:text-white">Email Flow</p>
                            <p className="text-sm sm:text-xs text-gray-500 dark:text-gray-400">Send & manage emails</p>
                          </div>
                        </div>
                      </button>
                      ...
                      <button
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-left">
                            <p className="font-medium text-base sm:text-sm text-gray-900 dark:text-white">Calendar Flow</p>
                            <p className="text-sm sm:text-xs text-gray-500 dark:text-gray-400">Schedule meetings</p>
                          </div>
                        </div>
                      </button>
                      ...
                      <button
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-left">
                            <p className="font-medium text-base sm:text-sm text-gray-900 dark:text-white">LinkedIn Flow</p>
                            <p className="text-sm sm:text-xs text-gray-500 dark:text-gray-400">Post & engage</p>
                          </div>
                        </div>
                      </button>
                      ...
                      <button
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-left">
                            <p className="font-medium text-base sm:text-sm text-gray-900 dark:text-white">Create Flow</p>
                            <p className="text-sm sm:text-xs text-gray-500 dark:text-gray-400">Build custom workflow</p>
                          </div>
                        </div>
                      </button>
                    </>
                ...
                <div className="mt-3 p-3 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg">
                  <p className="text-sm text-gray-700 dark:text-gray-300">
                    <span className="font-semibold">👋 Hi! I'm Tredy,</span> your AI workflow assistant. 
                    Click any flow above to get started, or type <code className="bg-white dark:bg-gray-800 px-2 py-0.5 rounded text-sm sm:text-xs font-mono">@agent</code> followed by your request.
                    I can help you send emails, schedule meetings, post on social media, and analyze your data!
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-center h-full bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900/20">
            <div className="text-center max-w-2xl p-8">
              ...
              <h1 className="text-4xl font-bold bg-gradient-to-r from-purple-600 via-pink-600 to-orange-600 bg-clip-text text-transparent mb-4">
                {user?.username ? `Welcome to Tredy, ${user.username}!` : 'Welcome to Tredy'}
              </h1>
              ...
              <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-4 text-left max-w-xl mx-auto">
                <div className="p-4 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl border border-blue-200 dark:border-blue-700">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-1">Email Workflows</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Compose, send, and manage emails</p>
                </div>
                <div className="p-4 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl border border-green-200 dark:border-green-700">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-1">Smart Scheduling</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">AI-powered meeting coordination</p>
                </div>
                <div className="p-4 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl border border-purple-200 dark:border-purple-700">
                  <div className="text-2xl mb-2">🚀</div>
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-1">Flow Automation</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Build custom AI workflows</p>
                </div>
              </div>
            </div>
          </div>
