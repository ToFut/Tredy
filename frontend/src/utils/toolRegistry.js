...
export const registerTool = (id, metadata) => toolRegistry.registerTool(id, metadata);
...
export const getToolsByCategory = (category) => toolRegistry.getToolsByCategory(category);