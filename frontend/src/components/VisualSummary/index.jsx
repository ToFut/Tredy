    ...
    <div className="my-4 glass-card rounded-2xl p-4 max-w-2xl">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          <div
            className={`w-10 h-10 rounded-xl bg-gradient-to-r ${getTypeGradient(summary?.type || "text")} flex items-center justify-center text-white`}
          >
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">
              {isGenerating
                ? "Generating..."
                : `${summary?.type} • ${summary?.confidence}% confidence`}
            </p>
          </div>
        </div>
        {!isGenerating && (
