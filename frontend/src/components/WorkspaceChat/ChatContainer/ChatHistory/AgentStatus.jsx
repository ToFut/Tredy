...
import { CheckCircle, Circle, Loader, ChevronRight, Brain, Search, Code, Sparkles } from "lucide-react";
      ...
      const interval = setInterval(() => {
        setCurrentStep(prev => {
          if (prev < statusSteps.length - 1) {
            ...
            setCompletedSteps(completed => [...completed, statusSteps[prev].id]);
            return prev + 1;
          }
          return prev;
        });
    ...
    <div className="relative my-4 animate-fadeIn">
      <div className="bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-white font-semibold">
                Agent @{agentName} 
                <span className="text-xs ml-2 text-green-400 font-normal">● Active</span>
              </h3>
          ...
          >
            <ChevronRight className={`w-4 h-4 transform transition-transform ${expandedView ? 'rotate-90' : ''}`} />
          </button>
        </div>
            ...
            return (
              ...
              `}>
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 flex items-center gap-2">
                    ...
                    <span className={`
                      ...
                      ${isPending ? 'text-gray-500' : ''}
                    `}>
                      {isCurrent ? (isTyping ? typedText : step.label) : step.label}
                      {isCurrent && isTyping && (
                ...
                {index < statusSteps.length - 1 && (
                  <div className="ml-4 mt-1 mb-1 w-0.5 h-4 bg-gradient-to-b 
