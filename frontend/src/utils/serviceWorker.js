...
function showUpdatePrompt() {
  ...
  updateBanner.className = 'fixed bottom-20 left-4 right-4 md:left-auto md:right-4 md:w-96 bg-blue-500 text-white p-4 rounded-lg shadow-lg z-50 app-slide-in-bottom';
...
function showInstallButton(deferredPrompt) {
  ...
  installButton.className = 'fixed bottom-4 right-4 bg-blue-500 text-white px-6 py-3 rounded-full shadow-lg z-50 app-button flex items-center gap-2';
