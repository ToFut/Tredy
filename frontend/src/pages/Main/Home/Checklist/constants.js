...
export const CHECKLIST_UPDATED_EVENT = "tredy_checklist_updated";
export const CHECKLIST_STORAGE_KEY = "tredy_checklist_completed";
export const CHECKLIST_HIDDEN = "tredy_checklist_dismissed";
