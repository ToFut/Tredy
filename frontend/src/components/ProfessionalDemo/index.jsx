...
const COMPANY_DATA = {
  ...
  description: "Family-owned construction company specializing in residential and commercial projects. Licensed, bonded, and insured with over 38 years of excellence.",
  stats: {
    projects: "150+",
    clients: "200+", 
    years: "38",
...
function ProfessionalChat({ isActive, onToggle }) {
  ...
  return (
    <div className={`fixed bottom-6 right-6 w-80 h-96 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 z-50 transform transition-all duration-500 ${
      isActive ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-full opacity-0 scale-95'
    }`}>
      {/* Chat Header */}
...
export default function ProfessionalDemo({ className = "" }) {
  ...
  return (
    <section className={`py-16 bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900/10 ${className}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-100 to-blue-100 dark:from-green-900/30 dark:to-blue-900/30 rounded-full mb-6">
            ...
            <span className="text-sm font-medium text-green-800 dark:text-green-200">Professional Website Integration</span>
          </div>
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-8">
            See how professional businesses integrate AI-powered customer service into their existing websites with seamless, elegant solutions.
          </p>
          ...
          <div className="relative bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 text-white p-6 relative overflow-hidden">
              ...
              <div className="relative z-10 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white">{COMPANY_DATA.name}</h3>
                    <p className="text-orange-100 text-sm font-medium">{COMPANY_DATA.tagline}</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="hidden md:flex items-center gap-2 text-orange-100">
                    <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                    <span className="text-sm font-medium">Call: {COMPANY_DATA.contact.phone}</span>
                  </div>
            ...
            <div className="relative">
              ...
              <div className="p-8 bg-gradient-to-br from-gray-50/90 to-white/90 backdrop-blur-sm">
                ...
                <div className="mb-12">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
                    {COMPANY_DATA.features.slice(0, 6).map((feature, index) => (
                      <div key={index} className="flex items-center gap-3 p-4 bg-white/90 backdrop-blur-sm rounded-xl shadow-sm border border-gray-100/50 hover:shadow-md hover:bg-white/95 transition-all duration-300">
                ...
                {/* Services Grid */}
                <div className="mb-12">
                  <h5 className="text-2xl font-bold text-gray-900 mb-6">Our Services</h5>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    {COMPANY_DATA.services.map((service, index) => (
                      <div key={index} className="group p-5 bg-white/90 backdrop-blur-sm rounded-xl border border-gray-100/50 hover:border-orange-200/50 hover:shadow-lg hover:bg-white/95 transition-all duration-300 cursor-pointer">
                        <div className="flex items-center gap-3">
              ...
              <div className="relative">
                ...
                <div className="p-8 bg-gradient-to-br from-blue-50/80 to-purple-50/80 backdrop-blur-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    <div>
                      <h5 className="text-2xl font-bold text-gray-900 mb-6">Why Choose Us</h5>
                      <div className="grid grid-cols-2 gap-4">
                        {Object.entries(COMPANY_DATA.stats).map(([key, value]) => (
                          <div key={key} className="text-center p-5 bg-gradient-to-br from-orange-50/90 to-orange-100/90 backdrop-blur-sm rounded-xl border border-orange-200/50 hover:shadow-md hover:from-orange-50/95 hover:to-orange-100/95 transition-all duration-300">
                    ...
                    <div>
                      <h5 className="text-2xl font-bold text-gray-900 mb-6">What Our Clients Say</h5>
                      <div className="space-y-4">
                        {COMPANY_DATA.testimonials.map((testimonial, index) => (
                          <div key={index} className="p-5 bg-white/90 backdrop-blur-sm rounded-xl border border-gray-100/50 shadow-sm hover:shadow-md hover:bg-white/95 transition-all duration-300">
                            ...
                            <p className="text-sm text-gray-700 italic leading-relaxed mb-2">"{testimonial.text}"</p>
                            <p className="text-xs text-gray-600 font-medium">— {testimonial.author}</p>
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-gray-600 mb-4">
                        Get a free estimate today. Call {COMPANY_DATA.contact.phone}
                      </p>
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute top-12 left-12 z-40">
              <div className="bg-white/95 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg border border-gray-200/50">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-semibold text-gray-800">Your Professional Website</span>
                </div>
              </div>
            ...
            <div className="absolute top-1/2 left-8 z-40">
              <div className="bg-gradient-to-r from-purple-500/95 to-pink-500/95 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg text-white">
                ...
                <div className="text-xs text-purple-100 mt-1">Business intelligence & automation</div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
          <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Easy Integration</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">Works with any website platform and design system</p>
          </div>
          ...
          <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">24/7 Automation</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">Handle customer inquiries and scheduling automatically</p>
          </div>
