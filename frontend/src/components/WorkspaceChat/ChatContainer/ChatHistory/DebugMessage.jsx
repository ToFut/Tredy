          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <span
                  className={`text-xs font-medium ${style.color} uppercase tracking-wider`}
                >
                  {style.prefix}
                </span>
                <span className="text-xs text-gray-500">{parsed.tool}</span>
              </div>

              <p className="text-sm text-gray-300 mb-1">{parsed.action}</p>
