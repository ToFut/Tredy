...
import { GearSix, UploadSimple, DotsSixVertical, CaretRight, Sparkle } from "@phosphor-icons/react";
...
export default function ActiveWorkspaces() {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (tooltipWorkspace && !event.target.closest('.workspace-item') && !event.target.closest('.summary-tooltip')) {
