...
export default function LandingPage() {
  ...
  const faqs = [
    {
      ...
      answer:
        "Tredy is an AI-powered workspace that connects, visualizes, and executes through threads. It integrates with 500+ apps and services, allowing you to manage your entire workflow through natural conversation.",
    },
    {
      question: "How does the thread system work?",
      answer:
        "Tredy uses intelligent threading to maintain context across complex tasks. Each thread represents a workflow that can span multiple tools and actions, keeping everything organized and traceable.",
    },
    {
      question: "Which integrations are available?",
      answer:
        "Tredy connects with 500+ apps including Gmail, Slack, Jira, GitHub, Figma, Google Calendar, Notion, and many more. You can use your own API keys or team-shared credentials.",
    },
    {
      question: "Is my data secure?",
      answer:
        "Yes. Tredy offers enterprise-grade security with end-to-end encryption, SOC 2 compliance, and the option to self-host. Your data never leaves your control.",
    },
    {
      question: "Can I customize Tredy for my team?",
      answer:
        "Absolutely. Tredy supports custom workflows, team-specific integrations, role-based access control, and white-label options for enterprise customers.",
    },
  ];
  ...
  const industryTestimonials = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1494790108755-2616b612b5c5?w=64&h=64&fit=crop&crop=face",
      quote:
        "Tredy automated our entire CI/CD pipeline. We reduced deployment time from 4 hours to 15 minutes while maintaining 99.9% reliability.",
    ...
    },
    {
      ...
      quote:
        "Our lead qualification process is now fully automated. Tredy routes 10,000+ leads daily across Salesforce, Slack, and our CRM with 94% accuracy.",
    ...
    },
    {
      ...
      quote:
        "Tredy connects our payment systems, compliance tools, and reporting dashboards. Monthly financial close went from 15 days to 3 days.",
    ...
    },
    {
      ...
      quote:
        "Our order fulfillment workflows now handle 100K+ daily orders automatically. Inventory, shipping, and customer service all sync perfectly.",
  ...
  const industryWorkflows = {
    Technology: {
      ...
      description:
        "Automate CI/CD, code reviews, deployment, and incident response",
    ...
    Finance: {
      ...
      description:
        "Streamline accounting, compliance reporting, and financial planning",
    ...
    Sales: {
      ...
      description:
        "Automate lead routing, opportunity management, and customer onboarding",
    ...
    Ecommerce: {
      ...
      description:
        "Automate inventory, fulfillment, customer service, and marketing",
  ...
  const validateEmail = (email) => {
    ...
    if (email.includes("+"))
      return "Business email preferred (avoid + aliases)";
    const freeProviders = [
      "gmail.com",
      "yahoo.com",
      "hotmail.com",
    ...
    if (freeProviders.includes(domain))
      return "Business email recommended for enterprise features";
    return "";
  };
  ...
  const onboardingSteps = [
    {
      ...
      content:
        "Start your journey with our 30-day free trial. No credit card required.",
      position: "bottom",
    },
    {
    ...
    },
    {
      ...
      content:
        'Click "Learn More" on any feature to see detailed capabilities.',
      position: "top",
    },
    {
      ...
      content:
        "Compare features and find the plan that scales with your business.",
      position: "top",
    },
  ];
  ...
  const handleWaitlistSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        showToast(
          "Thanks! You're on the waitlist. We'll notify you when Tredy is ready!",
          "success"
        );
      } else {
  ...
  const designSystem = {
    ...
    components: {
      ...
      button: {
        primary:
          "bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-full font-bold hover:from-purple-600 hover:to-indigo-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl",
        secondary:
          "border-2 border-purple-200 text-purple-600 rounded-full font-bold hover:border-indigo-300 hover:bg-gradient-to-r hover:from-purple-50 hover:to-indigo-50 transition-all duration-300",
        success:
          "bg-gradient-to-r from-emerald-400 to-teal-400 text-white rounded-full font-bold hover:from-emerald-500 hover:to-teal-500 transition-all duration-300",
        ghost:
          "text-purple-600 hover:text-indigo-600 font-semibold transition-colors",
        outline:
          "border-2 border-gray-300 text-gray-800 rounded-full font-bold hover:border-purple-300 hover:text-purple-700 transition-all duration-300",
      },
    },
  };
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
          ...
          <div className="bg-white rounded-2xl p-8 max-w-md mx-4 shadow-2xl">
            <div className="text-center mb-6">
              <div className="text-4xl mb-4">
                {onboardingSteps[onboardingStep].title.match(
                  /🎉|📊|🚀|💼/
                )?.[0] || "🎯"}
              </div>
            ...
            <div className="flex justify-between items-center mb-6">
              <div className="flex space-x-2">
                {onboardingSteps.map((_, i) => (
                  <div
                    key={i}
                    className={`w-3 h-3 rounded-full ${i === onboardingStep ? "bg-purple-600" : "bg-gray-200"}`}
                  ></div>
                ))}
              </div>
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 w-64 bg-white rounded-lg shadow-xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 mt-2">
                  <div className="p-4">
                    <a
                      href="#"
                      className="block px-3 py-2 text-gray-700 hover:text-purple-700 hover:bg-purple-50 rounded-md transition-colors"
                    >
                      Enterprise AI
                    </a>
                    <a
          ...
          {mobileMenuOpen && (
            <div className="md:hidden bg-white border-t border-gray-100 py-4">
              <div className="space-y-2">
                <a
                  href="#solutions"
                  className="block px-4 py-2 text-gray-700 hover:text-purple-700 transition-colors"
                >
                  Solutions
                </a>
                <a
                ...
                <Link
                  to="/login"
                  className="block mx-4 mt-4 px-6 py-2 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-full font-semibold text-center"
                >
                  {t("landing.cta.startTrial")}
                </Link>
              </div>
            ...
            <div className="text-center lg:text-left space-y-8">
              ...
              <div className="space-y-4">
                <p className="hero-description text-lg sm:text-xl lg:text-2xl text-slate-700 leading-relaxed max-w-2xl mx-auto lg:mx-0 font-medium">
                  ...
                  that connects every tool, understands context, and scales
                  infinitely.
                </p>
      ...
      <section
        className={`${designSystem.spacing.section} ${designSystem.spacing.container} bg-gray-50`}
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div
              className={`inline-flex items-center ${designSystem.spacing.buttonPadding} mb-8 bg-white/90 backdrop-blur-md text-purple-700 rounded-full text-sm font-bold border border-purple-200 shadow-lg`}
            >
              <Users className="w-5 h-5 mr-2" />
              Industry Solutions
            </div>
            <h2
              className={`${designSystem.typography.heading1} text-gray-900 dark:text-white mb-6`}
            >
              Built for Your{" "}
            ...
            <p
              className={`${designSystem.typography.body} text-gray-700 dark:text-gray-300 max-w-4xl mx-auto`}
            >
              Experience how Tredy AI creates intelligent business platforms
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-2xl p-8 text-white">
              ...
              <p className="text-purple-100 mb-6 max-w-2xl mx-auto">
                Tredy AI adapts to your specific industry needs, creating
                intelligent workflows that understand your business processes
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              <div
                key={i}
                className="border-2 border-gray-200 rounded-2xl overflow-hidden hover:border-purple-300 hover:shadow-lg transition-all duration-300"
              >
                <button
      ...
      <section className="py-24 px-6 bg-gradient-to-br from-purple-600 via-purple-700 to-pink-600 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <h2 className="text-5xl lg:text-6xl font-bold text-white mb-8">
            ...
            <span
              className="block text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-pink-400"
                  ...
                  <div>
                    ...
                    {email && !emailError && (
                      <p className="text-green-600 text-xs mt-1 flex items-center gap-1">
                        <span>✅</span> Great! We'll set up industry-specific
                        examples.
                      </p>
                    )}
                  </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
            <div className="sm:col-span-2 lg:col-span-2">
              ...
              <p className="text-purple-100 text-sm sm:text-base lg:text-lg mb-4 sm:mb-6 max-w-md">
                The future of intelligent workflows. Connect, visualize, and
                execute through AI-powered threads.
              </p>
              <div className="flex space-x-4">
                {["twitter", "linkedin", "github"].map((social) => (
                  <a
                    key={social}
                    href="#"
                    className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center text-white hover:text-purple-200 hover:bg-white/30 transition-colors"
                  >
            ...
            <div>
              ...
              <ul className="space-y-3">
                {["Features", "Integrations", "Security", "API", "Pricing"].map(
                  (item) => (
                    <li key={item}>
                      <a
                        href="#"
