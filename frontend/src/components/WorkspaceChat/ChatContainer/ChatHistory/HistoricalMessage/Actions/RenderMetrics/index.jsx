...
const SHOW_METRICS_KEY = "tredy_show_chat_metrics";
const SHOW_METRICS_EVENT = "tredy_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `tredy_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `tredy_show_chat_metrics` key
 * @returns {void}
 */
