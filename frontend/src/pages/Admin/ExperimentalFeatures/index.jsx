  ...
  if (!window.localStorage.getItem("tredy_tos_experimental_feature_set")) {
    function acceptTos(e) {
      ...
      window.localStorage.setItem(
        "tredy_tos_experimental_feature_set",
        "accepted"
      );
      showToast(
                ...
                <div className="w-full text-white text-md flex flex-col gap-y-4">
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono mt-2">
                      ...
                      <li>Potential bugs or issues using Tredy.</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono mt-2">
                      ...
                      <li>
                        ...
                        configurations, or subscriptions of Tredy.
                      </li>
                      <li>
                  ...
                  <p>
                    ...
                    <a
                      href="https://docs.tredy.com/beta-preview/overview"
